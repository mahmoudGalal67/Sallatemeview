...
function HomeElements({ settoggleSidebar }) {
  ...
  const [sections, setSections] = useState([
    { id: 1, name: "static banner" },
    { id: 2, name: "static banner" },
    { id: 3, name: "static banner" },
    { id: 4, name: "static banner" },
    { id: 5, name: "static banner" },
    { id: 6, name: "static banner" },
    { id: 7, name: "static banner" },
  ]);
